...
const Contatti = () => {
  return (
    // Sfondo primario (verde salvia scuro) per dare forte risalto alla fine della pagina
    <section id="contatti" className="py-20 text-white bg-primary">
      <div className="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-12 overflow-hidden bg-white shadow-2xl lg:flex-row text-textDark rounded-3xl">
          ...
          <div className="w-full p-10 lg:w-3/5">
            {/* L'attributo action andrà sostituito con il link generato da Formspree */}
            <form action="https://formspree.io/f/ID_PROVVISORIO" method="POST" className="space-y-6">
              ...
              {/* Privacy (Importante per siti medici/psicologici) */}
